ALTER TABLE exp_run RENAME TO exp_runBAK;
...
ALTER TABLE size RENAME TO sizeBAK;
ALTER TABLE sizeWK RENAME TO size;

ALTER TABLE RSS RENAME TO RSSBAK;
ALTER TABLE RSSWK RENAME TO RSS;
